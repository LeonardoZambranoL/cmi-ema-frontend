...
export default function Home() {
  ...
  const paragraph =
    "¡Bienvenidos a la Competencia de Matemáticas Intercolegial CMI 2024! Este año, nuestra edición anual se enorgullece de acoger a un mayor número de países, colegios y participantes.";
